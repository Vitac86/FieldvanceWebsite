  ...
  return (
    <section className="section-space pb-14 pt-14 sm:pb-16 sm:pt-16">
      <div className="container-page grid gap-10 lg:grid-cols-[1.07fr_0.93fr] lg:items-center lg:gap-12">
        ...
        <div className="rounded-xl border border-border-soft bg-white p-6 shadow-[0_3px_12px_rgba(15,23,42,0.06)] sm:p-7">
          <div className="rounded-lg bg-surface-dark p-5 text-slate-100">
            <div className="mb-4 flex items-center justify-between text-xs text-slate-300">
              <span>Dispatch context</span>
              <span className="accent-chip">Live workflow</span>
            </div>
            <div className="space-y-3">
              <div className="rounded-lg bg-surface-dark-soft p-3">
